...
//the form data is all the collected form information and image banner
  ...
  const putLink = `/api/contests/${props.concurso.id}<}update`
  ...
  return (
    ...
    <label>
      Nombre Concurso
      <input name="name" value={props.concurso.name} onChange={handleName} />
    </label>
    <br />
    <label>
      Identificador
      <input name="url" value={props.concurso.url}onChange={handleUrl} />
    </label>
    <label>
      Fecha Inicio
      <input name="date_start" value={props.concurso.date_start} onChange={handleDateS} type="date" />
    </label>
    <label>
      Fecha Fin
      <input name="date_end" value={props.concurso.date_end} onChange={handleDateE} type="date" />
    </label>
    <label>
      Premio
      <input name="pay" value={props.concurso.pay} onChange={handlePay}/>
    </label>
    <label>
      Guión
      <textarea name="script" value={props.concurso.script} onChange={handleScript} type="textarea" rows="7" cols="70"/>
    </label>
    <label>
      Tips
      <textarea name="tips" value={props.concurso.tips} onChange={handleTips} type="textarea" rows="7" cols="70"/>
    </label>
    <label>
      Banner
      <input
    ...
    </div> : <Navigate to ={`/contests/user/`}/>} </div>
